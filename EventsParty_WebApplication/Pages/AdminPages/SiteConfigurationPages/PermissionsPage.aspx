<%@ Page Title="Permissions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PermissionsPage.aspx.cs" Inherits="EventsParty_WebApplication.Pages.AdminPages.PermissionsPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnPermission").css("background-color", "#316EBB").css("color", "white").css("font-size", "16px");
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:Button runat="server" ID="btnAdd" Text="Add New Permission" ClientIDMode="Static" />
    <div id="dAdd">
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvItems" AutoGenerateColumns="False" DataKeyNames="Id" ShowHeaderWhenEmpty="True" OnRowCommand="gvItems_RowCommand" ClientIDMode="Static">
                ...
                <Columns>
                   ...
                   <asp:BoundField HeaderText="Permission" DataField="Type" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
