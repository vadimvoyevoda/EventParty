<%@ Page Title="Person Categories" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PersonCategoriesPage.aspx.cs" Inherits="EventsParty_WebApplication.Pages.AdminPages.PersonCategoriesPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnCategory").css("background-color", "#316EBB").css("color", "white").css("font-size", "16px");
        });
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:Button runat="server" ID="btnAdd" Text="Add New Category" ClientIDMode="Static" />
    <div id="dAdd">
    ...
    <asp:UpdatePanel runat="server" ID="upGrid" UpdateMode="Conditional" ClientIDMode="Static" ChildrenAsTriggers="False">
        ...
        <ContentTemplate>
            <asp:GridView runat="server" ID="gvItems" AutoGenerateColumns="False" DataKeyNames="Id" ShowHeaderWhenEmpty="True" OnRowCommand="gvItems_RowCommand" ClientIDMode="Static">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Person Category" DataField="Category" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
