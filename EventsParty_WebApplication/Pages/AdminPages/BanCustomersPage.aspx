<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BanCustomersPage.aspx.cs" Inherits="EventsParty_WebApplication.Pages.AdminPages.BanCustomersPage" %>
            ...
            <asp:GridView runat="server" ID="gvUsers" DataKeyNames="Id" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Login">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" Text='<%#Eval("Login")%>' NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"Id", "~/Pages/AdminPages/BanCustomersInfoPage.aspx?id={0}") %>' ItemStyle-HorizontalAlign="Center" ToolTip="Show More Info"/>
                        </ItemTemplate>
                    </asp:TemplateField>
