...
{
    public partial class BanCustomersInfoPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsCallback && !IsPostBack)
            {
                ...
                CurrentUser = store.GetBannedUsers().FirstOrDefault(c => c.Id == id);
                LoadData();
            }
        }
        ...
        {
            manager.RemoveFromBanList(CurrentUser.Id);
            Response.Redirect("/Pages/AdminPages/CustomersPage.Aspx");
        }

        protected void btnDel_Click(object sender, EventArgs e)
        {
            manager.DeleteUser(CurrentUser.Id);
