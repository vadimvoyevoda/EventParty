<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CustomerInfoPage.aspx.cs" Inherits="EventsParty_WebApplication.Pages.AdminPages.CustomerInfoPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div id="info">
        ...
        <div>
            <asp:Label ID="Label9" runat="server" Text="OrganizedEventCount:" />
            <asp:Label runat="server" ID="lbOrgEventCount" />
        </div>
        <div>
        <asp:Label ID="Label10" runat="server" Text="Permission:" />
    ...
    <div>
        ...
        <asp:Button runat="server" ID="btnBan" Text="Add to BanList" CssClass="banClass" OnClick="btnBan_Click"/>
        <asp:Button runat="server" ID="btnDel" Text="Delete" CssClass="delClass" OnClick="btnDel_Click"/>
    </div>
</asp:Content>
