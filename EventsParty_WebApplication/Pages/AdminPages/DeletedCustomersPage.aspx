<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DeletedCustomersPage.aspx.cs" Inherits="EventsParty_WebApplication.Pages.AdminPages.DeletedCustomersPage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#btnDeleted").css("background-color", "#316EBB").css("color", "white").css("font-size", "16px");
            $("#dCustomers").show();
            ...
            <asp:GridView runat="server" ID="gvUsers" DataKeyNames="Id" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Photo">
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%#GetImage(Eval("Photo")) %>'/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Login">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" runat="server" Text='<%#Eval("Login")%>' NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"Id", "~/Pages/AdminPages/DeletedCustomersInfoPage.aspx?id={0}") %>' ItemStyle-HorizontalAlign="Center" ToolTip="Show More Info"/>
                        </ItemTemplate>
                    </asp:TemplateField>
