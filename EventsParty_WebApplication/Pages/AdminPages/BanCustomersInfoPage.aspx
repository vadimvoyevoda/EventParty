<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BanCustomersInfoPage.aspx.cs" Inherits="EventsParty_WebApplication.Pages.AdminPages.BanCustomersInfoPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div>
        ...
        <asp:Button runat="server" ID="btnBan" Text="Return from BanList" CssClass="banClass" OnClick="btnBan_Click"/>
